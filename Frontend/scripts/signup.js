...
document.getElementById("edit_button").addEventListener("click", function () {
    ...
    let e = document.getElementById("enter_password");
    let f = document.getElementById("enter_username")
...
async function Register(event) {
    try {
        ...
        let register_data = {
           ...
           const res =await fetch("https://nice-cyan-pike-vest.cyclic.app/users/register",{
            method: 'POST',
            headers: {
